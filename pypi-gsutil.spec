...
Version  : 5.11
Release  : 84
URL      : https://files.pythonhosted.org/packages/00/4c/682497ade96132666aa26f179c9bf1d97d118a5936afc36f1bbc6da9ada3/gsutil-5.11.tar.gz
Source0  : https://files.pythonhosted.org/packages/00/4c/682497ade96132666aa26f179c9bf1d97d118a5936afc36f1bbc6da9ada3/gsutil-5.11.tar.gz
...
%prep
%setup -q -n gsutil-5.11
cd %{_builddir}/gsutil-5.11
pushd ..
cp -a gsutil-5.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657292031
...
cp %{_builddir}/gsutil-5.11/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-5.11/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-5.11/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
