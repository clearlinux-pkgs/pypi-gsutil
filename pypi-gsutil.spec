...
Version  : 5.9
Release  : 78
URL      : https://files.pythonhosted.org/packages/26/df/625d5c4acee4ed2f987b2c053dc5332bebd5c5b8a7acee4ee375942fe993/gsutil-5.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/26/df/625d5c4acee4ed2f987b2c053dc5332bebd5c5b8a7acee4ee375942fe993/gsutil-5.9.tar.gz
...
%prep
%setup -q -n gsutil-5.9
cd %{_builddir}/gsutil-5.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649376565
...
cp %{_builddir}/gsutil-5.9/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-5.9/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-5.9/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
