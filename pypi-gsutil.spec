...
Version  : 5.16
Release  : 95
URL      : https://files.pythonhosted.org/packages/e9/db/13dbca8b3544092739740406e00b63dbbee7af1f95dcab3e59e4700b9e88/gsutil-5.16.tar.gz
Source0  : https://files.pythonhosted.org/packages/e9/db/13dbca8b3544092739740406e00b63dbbee7af1f95dcab3e59e4700b9e88/gsutil-5.16.tar.gz
...
%prep
%setup -q -n gsutil-5.16
cd %{_builddir}/gsutil-5.16
pushd ..
cp -a gsutil-5.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666923629
