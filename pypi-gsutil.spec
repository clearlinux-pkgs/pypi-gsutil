...
Version  : 5.8
Release  : 77
URL      : https://files.pythonhosted.org/packages/a8/92/0a080fb928353157ad81102b215907eec4ef1e49eac7110f676ecd7d5328/gsutil-5.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/a8/92/0a080fb928353157ad81102b215907eec4ef1e49eac7110f676ecd7d5328/gsutil-5.8.tar.gz
...
%prep
%setup -q -n gsutil-5.8
cd %{_builddir}/gsutil-5.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646749369
...
cp %{_builddir}/gsutil-5.8/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-5.8/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-5.8/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
