...
Version  : 5.13
Release  : 90
URL      : https://files.pythonhosted.org/packages/20/10/d37a8362605e28f1d19ab2a00e8461bf49fe41330cecc6043d29a50b2653/gsutil-5.13.tar.gz
Source0  : https://files.pythonhosted.org/packages/20/10/d37a8362605e28f1d19ab2a00e8461bf49fe41330cecc6043d29a50b2653/gsutil-5.13.tar.gz
...
%prep
%setup -q -n gsutil-5.13
cd %{_builddir}/gsutil-5.13
pushd ..
cp -a gsutil-5.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662600034
