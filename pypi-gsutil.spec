...
Version  : 5.15
Release  : 92
URL      : https://files.pythonhosted.org/packages/ee/28/3ab5071cf8f163d8a9d0e95affa0512422811113111ae802ddff7af5074c/gsutil-5.15.tar.gz
Source0  : https://files.pythonhosted.org/packages/ee/28/3ab5071cf8f163d8a9d0e95affa0512422811113111ae802ddff7af5074c/gsutil-5.15.tar.gz
...
%prep
%setup -q -n gsutil-5.15
cd %{_builddir}/gsutil-5.15
pushd ..
cp -a gsutil-5.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666135766
