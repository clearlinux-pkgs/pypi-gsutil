...
Version  : 5.14
Release  : 91
URL      : https://files.pythonhosted.org/packages/df/7d/93e84d9d11b6cd753da663486eeb530ec01574018a792ab12de5c4b1526c/gsutil-5.14.tar.gz
Source0  : https://files.pythonhosted.org/packages/df/7d/93e84d9d11b6cd753da663486eeb530ec01574018a792ab12de5c4b1526c/gsutil-5.14.tar.gz
...
%prep
%setup -q -n gsutil-5.14
cd %{_builddir}/gsutil-5.14
pushd ..
cp -a gsutil-5.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663888315
