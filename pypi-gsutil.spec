...
Version  : 5.18
Release  : 100
URL      : https://files.pythonhosted.org/packages/9a/d3/9b7d69864232617c97f58802e924deb73768214f29fa7105c4572cae3054/gsutil-5.18.tar.gz
Source0  : https://files.pythonhosted.org/packages/9a/d3/9b7d69864232617c97f58802e924deb73768214f29fa7105c4572cae3054/gsutil-5.18.tar.gz
...
%prep
%setup -q -n gsutil-5.18
cd %{_builddir}/gsutil-5.18
pushd ..
cp -a gsutil-5.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673625785
