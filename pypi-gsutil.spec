...
Version  : 5.7
Release  : 76
URL      : https://files.pythonhosted.org/packages/c1/28/fc6f5fc2f25db6337c9e8e7b95a62d6c7879a652b46c9b7402c376caf811/gsutil-5.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/c1/28/fc6f5fc2f25db6337c9e8e7b95a62d6c7879a652b46c9b7402c376caf811/gsutil-5.7.tar.gz
...
%prep
%setup -q -n gsutil-5.7
cd %{_builddir}/gsutil-5.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646415135
...
cp %{_builddir}/gsutil-5.7/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-5.7/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-5.7/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
