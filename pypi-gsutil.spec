...
Version  : 5.6
Release  : 75
URL      : https://files.pythonhosted.org/packages/f0/14/0d72d823e9e09e9e0a55a433d7ca0cf99c7ef38c30360dffa6a043230772/gsutil-5.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/f0/14/0d72d823e9e09e9e0a55a433d7ca0cf99c7ef38c30360dffa6a043230772/gsutil-5.6.tar.gz
...
%prep
%setup -q -n gsutil-5.6
cd %{_builddir}/gsutil-5.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642005032
...
cp %{_builddir}/gsutil-5.6/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/gsutil-5.6/gslib/vendored/boto/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/875c7866415e9e58a4c515bd052d001ac5107943
cp %{_builddir}/gsutil-5.6/gslib/vendored/oauth2client/LICENSE %{buildroot}/usr/share/package-licenses/pypi-gsutil/a7b6feb97b476557d3d699fa1f20090fb956d662
