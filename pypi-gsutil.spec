...
Version  : 5.19
Release  : 101
URL      : https://files.pythonhosted.org/packages/2c/08/eefea50b730baafdd1a678e42d21997dbb134b9368def51e5796190bb86d/gsutil-5.19.tar.gz
Source0  : https://files.pythonhosted.org/packages/2c/08/eefea50b730baafdd1a678e42d21997dbb134b9368def51e5796190bb86d/gsutil-5.19.tar.gz
...
%prep
%setup -q -n gsutil-5.19
cd %{_builddir}/gsutil-5.19
pushd ..
cp -a gsutil-5.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674834357
